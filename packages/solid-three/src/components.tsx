 ...
 */
export function Entity<T extends object | Constructor<object>>(props: Prettify<EntityProps<T>>) {
...
export function Resource<const TLoader extends Loader<object, any>>(props: ResourceProps<TLoader>) {
  ...
  return (
    <Show when={"children" in config && resource()} fallback={<Entity from={resource()} />}>
